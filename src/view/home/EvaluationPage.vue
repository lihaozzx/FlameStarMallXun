    ...
    <div class="EvaluationPage">
      ...
      <div
        ...
        <div class="evaluation-top">
          ...
          <div class="evaluation-top-center">
            <div class="name" style="margin-left: 0.8rem">
              <van-rate
                readonly
                style="height: 0.37rem"
                v-model="item.score"
        ...
        <div v-if="item.userInteractDetails.length > 0 && item.userInteractDetails[0].content" class="shop-reply">
        ...
        <div class="evaluation-img-box">
          <img v-for="(item2, index2) in item.interactImageUrlList" :key="index2" :src="item2" alt="">
        </div>
      </div>
    </div>
</template>
