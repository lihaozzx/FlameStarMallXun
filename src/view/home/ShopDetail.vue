...
<div class="shop-detail">
    ...
    <div class="right">
      <div>
        <div style="display: flex">
          <div v-if="shopInfo.channel === 1" class="icon">
            自营
          </div>
          <div class="name">
            {{shopInfo.name}}
  ...
  <div v-if="shopInfo.appletQrCodeUrl || shopInfo.intro" class="shop-detail_intro">
    <div v-if="shopInfo.intro" class="intro">
     {{shopInfo.intro}}
    </div>
    <img v-if="shopInfo.appletQrCodeUrl" class="img" :src="shopInfo.appletQrCodeUrl" alt="">
  </div>
  <div class="quality">
    <div class="item">
      <img src="../../assets/goods/ic_goods.png" alt="">
      店铺商品
    </div>
  </div>
  <div>
