<template>
  <div class="mine">
    ...
    <div class="mine-info">
      <div class="top">
        <img
          v-if="myInfo.avatarKey"
          @click="goUpDataInfo"
          class="img"
          :src="myInfo.avatarKey"
        >
        <img
          v-else
          @click="goUpDataInfo"
      ...
      <div
        v-if="myInfo.isMember === 1"
        class="bottom"
      >
        <img
          class="bottom-icon"
          src="../../assets/mine/my_imassage_huiy_icon.png"
          alt=""
        >
      ...
      >
        <img
          class="bottom-icon"
          src="../../assets/mine/my_imassage_nohuiy_icon.png"
          alt=""
        >
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_order_icon@2x.png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    <div class="order-container">
      ...
      >
        ...
        <img
          ...
          src="../../assets/mine/my_order_list1_icon@2x.png"
          alt=""
        >
      ...
      <div class="order-item">
        ...
        <img
          @click="goOder(4)"
          class="order-item-img"
          src="../../assets/mine/my_order_list2_icon@2x.png"
          alt=""
        >
      ...
      >
        ...
        <img
          class="order-item-img"
          src="../../assets/mine/my_order_list3_icon@2x.png"
          alt=""
        >
      ...
      >
        ...
        <img
          class="order-item-img"
          src="../../assets/mine/my_order_list4_icon@2x.png"
          alt=""
        >
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_service_icon@2x.png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    <div class="service-container">
      <div
        @click="goCommissionPage"
        class="service-item"
      >
        <img
          class="service-item-img"
          src="../../assets/mine/my_service_list1_icon@2x.png"
          alt=""
        >
      ...
      >
        <img
          class="service-item-img"
          src="../../assets/mine/my_service_list2_icon@2x.png"
          alt=""
        >
        <div class="service-item-container">
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_otherservice_list1_icon@2x(1).png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_otherservice_list2_icon@2x.png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_otherservice_list3_icon@2x.png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_otherservice_list5_icon@2x.png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    >
      <template slot="icon">
        <img
          class="order-img"
          src="../../assets/mine/my_otherservice_list1_icon@2x.png"
          alt=""
        >
      </template>
      <template slot="title">
    ...
    >
      <div class="invite-code">
        <img
          src="../../assets/mine/my_code_bg.png"
          alt=""
        >
        <div class="content">
          ...
          <div
            class="copy"
            :data-clipboard-text="myInfo.inviterCode"
            @click="copy"
          >
            点击复制
          </div>
          ...
          <div class="referees-img">
            <img
              v-if="myInfo.inviterAvatarKey"
              :src="myInfo.inviterAvatarKey"
              alt=""
            >
            <img
              v-else
...
.mine {
  ...
  .mine-info {
    ...
    .bottom {
      ...
      background: linear-gradient(
        90deg,
        rgba(252, 241, 218, 1) 0%,
        rgba(250, 228, 184, 1) 100%
      );
